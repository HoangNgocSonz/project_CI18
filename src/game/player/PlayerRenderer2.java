...
public class PlayerRenderer2 extends Renderer {
    ...
    String[] pat;
        ...
        pat = new String[4];
            pat[0] = "assets/images/SuperMinion/Super_Up";
            pat[1] = "assets/images/SuperMinion/Super_Down";
            pat[2] = "assets/images/SuperMinion/Super_Right";
            pat[3] = "assets/images/SuperMinion/Super_Left";
